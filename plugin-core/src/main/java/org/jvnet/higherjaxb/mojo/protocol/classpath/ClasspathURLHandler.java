 ...
 * to read resources from the classpath.
 * </p>
 * 
 * <p>
   ...
   extends URLStreamHandler
{
    ...
    /**
     * Opens a connection to the classpath referenced by the given {@link URL}.
     *
     * @param url A URL for the classpath resource connection.
     * 
   ...
   protected URLConnection openConnection(URL url, Proxy proxy)
	  throws IOException
   {
	   // ClasspathURLConnection does not support proxy at this time.
